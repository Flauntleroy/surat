...
const AppHeader: React.FC<AppHeaderProps> = ({ userImage, userName }) => {
      ...
      <div className="flex items-center justify-between w-full px-3 py-3 lg:px-6 lg:py-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="/dashboard" className="lg:hidden flex items-center gap-2">
            <img src="/LogoDWP.png" alt="Logo DWP" className="w-8 h-8 object-contain" />
            ...
            {dropdownOpen && (
              <div className="absolute right-0 mt-2 w-56 rounded-xl border border-gray-200 bg-white py-2 shadow-theme-lg dark:border-gray-800 dark:bg-gray-900">
                <div className="px-4 py-2 border-b border-gray-100 dark:border-gray-800">
                  <p className="text-sm font-medium text-gray-800 dark:text-white/90 truncate">{userName}</p>
                </div>
